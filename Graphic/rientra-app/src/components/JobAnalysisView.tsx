        ...
        <div className="ja-card ja-scatter-card">
          ...
          >
            ...
            <g clipPath="url(#ja-clip)">
              <polygon points={zonePoly('green')}  fill="#22c55e" opacity="0.10" />
              <polygon points={zonePoly('yellow')} fill="#f59e0b" opacity="0.10" />
              <polygon points={zonePoly('red')}    fill="#ef4444" opacity="0.10" />
            </g>
            ...
            <line x1={svgX(0)} y1={svgY(21)}   x2={svgX(42)} y2={svgY(0)}
              ...
              opacity="0.55" clipPath="url(#ja-clip)" />
            <line x1={svgX(0)} y1={svgY(15.5)} x2={svgX(31)} y2={svgY(0)}
              stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="6,4"
              opacity="0.55" clipPath="url(#ja-clip)" />

            {/* Zone labels */}
            <text x={svgX(1.5)} y={svgY(23)} fontSize="9.5" fill="rgba(239,68,68,0.55)" fontStyle="italic">NOT SUITABLE</text>
            <text x={svgX(1.5)} y={svgY(13)} fontSize="9.5" fill="rgba(245,158,11,0.55)" fontStyle="italic">WITH PRECAUTIONS</text>
            <text x={svgX(1.5)} y={svgY(3.5)} fontSize="9.5" fill="rgba(34,197,94,0.55)"  fontStyle="italic">SUITABLE</text>
            ...
            {X_TICKS.map(t => (
              <g key={`xt${t}`}>
                <line x1={svgX(t)} y1={PAD.t+PH} x2={svgX(t)} y2={PAD.t+PH+4}
                  stroke="rgba(255,255,255,0.3)" strokeWidth="1" />
                <text x={svgX(t)} y={PAD.t+PH+15} textAnchor="middle" fontSize="10" fill="rgba(255,255,255,0.42)">{t}</text>
              </g>
            ))}
            {/* Y axis */}
            {Y_TICKS.map(t => (
              <g key={`yt${t}`}>
                <line x1={PAD.l-4} y1={svgY(t)} x2={PAD.l} y2={svgY(t)}
                  stroke="rgba(255,255,255,0.3)" strokeWidth="1" />
                <text x={PAD.l-8} y={svgY(t)+3.5} textAnchor="end" fontSize="10" fill="rgba(255,255,255,0.42)">{t}</text>
              </g>
            ))}
                  ...
                  {skillData.skills.map((s, i) => {
                    ...
                    return (
                      <tr key={`${s.id}-${i}`}>
                        ...
                        <td className="ja-td-crit" style={{ color }}>{s.criticality_label}</td>
                      </tr>
                    );
                  })}
                </tbody>
